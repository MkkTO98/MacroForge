...
- `TASK-225-source-native-corporate-reporting-release-candidate.md`
<!-- PROJECTFORGE:END-CONTAINS -->

## Active Work
- `TASK-225-source-native-corporate-reporting-release-candidate.md` is complete and closes through governance reconciliation. All remediation, successor, focused, integration, two-database rehearsal, and 673-item replacement complete-suite gates passed; the exact 29-path freeze received three unconditional identical-byte reviews before direct one-commit Git publication in `7379417873564f5412bcbd4fc2725ba7a1841c3d`. Git publication granted no governed admission, dataset release, redistribution, delivery, or successor authority; the candidate remains private-analysis-only, no successor is active or defined, and the repository is idle pending explicit user direction.
...
- `TASK-216-imf-bop-phase2-current-account-expansion.md` is complete and published in commit `d27d3acd72bbf73a8099b416d14865c96cd4c286`: IMF BOP annual current-account monitoring, 214 accepted countries, 1,070 provider-advertised series, 16,050 candidate cells, 14,475 loaded facts (13,600 provider-valued, 875 explicit-missing), 105 whole-series absences, 0 acquisition errors/incompatible series/duplicates, source `IMF_SDMX_BOP_API_V1`, dataset `IMF:BOP`, as-of `imf-bop-asof-20260711t231424302015100z`.
...
- `TASK-215-bis-credit-gap-phase2-repository-expansion.md` — completed BIS WS_CREDIT_GAP quarterly credit-to-GDP-gap Phase 2 campaign: 43 accepted territories, 43 exact provider-advertised private-nonfinancial-sector/all-lenders/credit-gap series, 1 source-scoped percentage-point credit-gap indicator, 2010-Q1 through 2025-Q4, 2,752 loaded provider-valued facts, 0 explicit-missing, XM Euro area aggregate excluded, 0 acquisition errors, provider-prepared snapshot/as-of identity `bis-ws-credit-gap-snapshot-prepared-20260712t162752z`, 0 duplicate key groups, same-run idempotence, later-snapshot coexistence simulation passed, and a narrow BIS-specific helper substrate was extracted in `src/macroforge/bis_sdmx.py`.
