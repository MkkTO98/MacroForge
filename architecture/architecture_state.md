...
This lightweight generated-project architecture state file connects MacroForge to the current MetaHarvest advisory integration contract while preserving the local compatibility folder name `architecture/metaharvest/`.
...
- First MacroForge MetaHarvest compatibility review: source project `MetaHarvest`, repository-relative evidence `reviews/R-20260608-macroforge-first-architectureharvest-review.md`
