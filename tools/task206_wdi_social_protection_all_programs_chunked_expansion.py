...
TASK_ID = "TASK-206"
CAMPAIGN_NAME = "WDI Social Protection All-Programs Chunked Expansion Campaign"
CAMPAIGN_MODE = "Large Campaign Execution Optimization"
SOURCE_NAME = "World Bank World Development Indicators social protection and labor all-program indicators"
COUNTRY_CATALOG_FIXTURE = PROJECT_ROOT / "data/raw/wdi_operational_phase1/wdi-phase1-all-countries-3i-2000-2023.json"
BASE_RAW_DIR = PROJECT_ROOT / "data/raw/task206_wdi_social_protection_all_programs_chunked_expansion"
BASE_PROCESSED_DIR = PROJECT_ROOT / "data/processed/task206_wdi_social_protection_all_programs_chunked_expansion"
CHECKPOINT_DIR = BASE_RAW_DIR / "checkpoints"
RAW_CHUNK_DIR = BASE_RAW_DIR / "chunks"
NORM_CHUNK_DIR = BASE_PROCESSED_DIR / "chunks"
MANIFEST_PATH = BASE_PROCESSED_DIR / "task-206-wdi-social-protection-all-programs-chunked-manifest.json"
DATE_RANGE = "1990:2024"
PERIODS = [str(y) for y in range(1990, 2025)]
CHUNK_SIZE = 80
CANDIDATE_INDICATORS = [
    'per_allsp.adq_ep_preT_tot',
    'per_allsp.adq_ep_tot',
    'per_allsp.adq_pop_rur',
    'per_allsp.adq_pop_tot',
    'per_allsp.adq_pop_urb',
    'per_allsp.adq_q1_preT_tot',
    'per_allsp.adq_q1_rur',
    'per_allsp.adq_q1_tot',
    'per_allsp.adq_q1_urb',
    'per_allsp.adq_q2_preT_tot',
    'per_allsp.adq_q2_rur',
    'per_allsp.adq_q2_tot',
    'per_allsp.adq_q2_urb',
    'per_allsp.adq_q3_preT_tot',
    'per_allsp.adq_q3_rur',
    'per_allsp.adq_q3_tot',
    'per_allsp.adq_q3_urb',
    'per_allsp.adq_q4_preT_tot',
    'per_allsp.adq_q4_rur',
    'per_allsp.adq_q4_tot',
    'per_allsp.adq_q4_urb',
    'per_allsp.adq_q5_preT_tot',
    'per_allsp.adq_q5_rur',
    'per_allsp.adq_q5_tot',
    'per_allsp.adq_q5_urb',
    'per_allsp.avt_ep_preT_tot',
    'per_allsp.avt_ep_tot',
    'per_allsp.avt_pop_preT_tot',
    'per_allsp.avt_pop_rur',
    'per_allsp.avt_pop_tot',
    'per_allsp.avt_pop_urb',
    'per_allsp.avt_q1_preT_tot',
    'per_allsp.avt_q1_rur',
    'per_allsp.avt_q1_tot',
    'per_allsp.avt_q1_urb',
    'per_allsp.avt_q2_preT_tot',
    'per_allsp.avt_q2_rur',
    'per_allsp.avt_q2_tot',
    'per_allsp.avt_q2_urb',
    'per_allsp.avt_q3_preT_tot',
    'per_allsp.avt_q3_rur',
    'per_allsp.avt_q3_tot',
    'per_allsp.avt_q3_urb',
    'per_allsp.avt_q4_preT_tot',
    'per_allsp.avt_q4_rur',
    'per_allsp.avt_q4_tot',
    'per_allsp.avt_q4_urb',
    'per_allsp.avt_q5_preT_tot',
    'per_allsp.avt_q5_rur',
    'per_allsp.avt_q5_tot',
    'per_allsp.avt_q5_urb',
    'per_allsp.ben_ep_preT_tot',
    'per_allsp.ben_ep_tot',
    'per_allsp.ben_q1_preT_tot',
    'per_allsp.ben_q1_rur',
    'per_allsp.ben_q1_tot',
    'per_allsp.ben_q1_urb',
    'per_allsp.ben_q2_preT_tot',
    'per_allsp.ben_q2_rur',
    'per_allsp.ben_q2_tot',
    'per_allsp.ben_q2_urb',
    'per_allsp.ben_q3_preT_tot',
    'per_allsp.ben_q3_rur',
    'per_allsp.ben_q3_tot',
    'per_allsp.ben_q3_urb',
    'per_allsp.ben_q4_preT_tot',
    'per_allsp.ben_q4_rur',
    'per_allsp.ben_q4_tot',
    'per_allsp.ben_q4_urb',
    'per_allsp.ben_q5_preT_tot',
    'per_allsp.ben_q5_rur',
    'per_allsp.ben_q5_tot',
    'per_allsp.ben_q5_urb',
    'per_allsp.bry_ep_preT_tot',
    'per_allsp.bry_ep_tot',
    'per_allsp.bry_q1_preT_tot',
    'per_allsp.bry_q1_rur',
    'per_allsp.bry_q1_tot',
    'per_allsp.bry_q1_urb',
    'per_allsp.bry_q2_preT_tot',
    'per_allsp.bry_q2_rur',
    'per_allsp.bry_q2_tot',
    'per_allsp.bry_q2_urb',
    'per_allsp.bry_q3_preT_tot',
    'per_allsp.bry_q3_rur',
    'per_allsp.bry_q3_tot',
    'per_allsp.bry_q3_urb',
    'per_allsp.bry_q4_preT_tot',
    'per_allsp.bry_q4_rur',
    'per_allsp.bry_q4_tot',
    'per_allsp.bry_q4_urb',
    'per_allsp.bry_q5_preT_tot',
    'per_allsp.bry_q5_rur',
    'per_allsp.bry_q5_tot',
    'per_allsp.bry_q5_urb',
    'per_allsp.cba_ep_tot',
    'per_allsp.cba_q1_rur',
    'per_allsp.cba_q1_tot',
    'per_allsp.cba_q1_urb',
    'per_allsp.cov_ep_preT_tot',
    'per_allsp.cov_ep_tot',
    'per_allsp.cov_pop_rur',
    'per_allsp.cov_pop_tot',
    'per_allsp.cov_pop_urb',
    'per_allsp.cov_q1_preT_tot',
    'per_allsp.cov_q1_rur',
    'per_allsp.cov_q1_tot',
    'per_allsp.cov_q1_urb',
    'per_allsp.cov_q2_preT_tot',
    'per_allsp.cov_q2_rur',
    'per_allsp.cov_q2_tot',
    'per_allsp.cov_q2_urb',
    'per_allsp.cov_q3_preT_tot',
    'per_allsp.cov_q3_rur',
    'per_allsp.cov_q3_tot',
    'per_allsp.cov_q3_urb',
    'per_allsp.cov_q4_preT_tot',
    'per_allsp.cov_q4_rur',
    'per_allsp.cov_q4_tot',
    'per_allsp.cov_q4_urb',
    'per_allsp.cov_q5_preT_tot',
    'per_allsp.cov_q5_rur',
    'per_allsp.cov_q5_tot',
    'per_allsp.cov_q5_urb',
    'per_allsp_gini_rur',
    'per_allsp_gini_tot',
    'per_allsp_gini_urb',
    'per_allsp_p0_ep_tot',
...
def _row_country_code(row: dict[str, Any], allowed: set[str] | None = None) -> str | None:
    """Return the repository country code for a WDI row.

    Most WDI endpoints populate countryiso3code. ASPIRE social-protection
    indicators return an empty countryiso3code even for country rows, while
    row['country']['id'] carries the WDI country code. Treat country.id as a
    bounded fallback only when it is inside the accepted non-aggregate catalog.
    """
    iso = row.get("countryiso3code")
    if iso and (allowed is None or iso in allowed):
        return str(iso)
    country = row.get("country") or {}
    cid = country.get("id")
    if cid and (allowed is None or cid in allowed):
        return str(cid)
    return str(iso) if iso else (str(cid) if cid else None)


def _get_json(url: str, timeout_seconds: int) -> Any:
    req = urllib.request.Request(url, headers={"User-Agent": "MacroForge TASK-206 WDI social protection all-programs chunked expansion"})
    ...
    for _ in range(3):
        try:
            ...
            if isinstance(payload, list) and len(payload) == 2 and isinstance(payload[1], list):
                ...
                payload = [dict(payload[0]), [r for r in payload[1] if _row_country_code(r, allowed) in allowed]]
...
def base_scope(indicators: list[str], chunk_index: int | None = None) -> dict[str, Any]:
    ...
    return {"task": TASK_ID, "campaign": CAMPAIGN_NAME, "mode": CAMPAIGN_MODE,
        ...
        "domain": "Social protection, labor-market protection, and household-transfer systems", "analytical_capability": "social protection program reach, adequacy, incidence, benefit distribution, and poverty/inequality reduction monitoring",
        "confidence_cell": "WDI public API v2 annual scalar country-indicator observations for aggregate all-program social protection and labor indicators",
...
def fetch_raw(timeout_seconds: int = 45, max_workers: int = 16) -> dict[str, Any]:
    ...
    for idx, indicators in enumerate(_chunks(CANDIDATE_INDICATORS, CHUNK_SIZE), start=1):
        ...
        raw_path=RAW_CHUNK_DIR / f"task-206-wdi-social-protection-all-programs-raw-chunk-{idx:02d}.json"
...
def classify(raw: dict[str, Any], min_non_null_observations: int=1) -> dict[str, Any]:
    ...
    for req in raw['requests']:
        ...
        if isinstance(meta, dict) and 'error' in meta:
            ev['classification']='provider_unavailable'; ev['provider_evidence_category']='acquisition_error'; ev['exclusion_evidence']=json.dumps({'error': meta.get('error'), 'message': meta.get('message')}, sort_keys=True)
            outside.append(indicator); excluded.append(indicator); results[indicator]=ev; continue
        ...
        for row in obs:
            ind=row.get('indicator') or {}; c=row.get('country') or {}; iso=_row_country_code(row, country_set); per=str(row.get('date')); label=label or ind.get('value')
...
def normalize(raw: dict[str, Any]) -> dict[str, Any]:
    ...
    for req in raw['requests']:
        ...
        for item in obs:
            ind=item.get('indicator') or {}; country=item.get('country') or {}; iso=_row_country_code(item, set(countries)); cat=catalog.get(iso,{})
            rows.append({"source": SOURCE_NAME, "indicator_id": ind.get('id'), "indicator_name": ind.get('value'), "country_id": country.get('id'), "country_name": (cat.get('name') or cat.get('value') or country.get('value')), "countryiso3code": iso, "provider_countryiso3code": item.get('countryiso3code'), "date": str(item.get('date')), "value": item.get('value'), "unit": item.get('unit') or None, "obs_status": item.get('obs_status') or None, "decimal": item.get('decimal'), "repository_section": "social_protection_all_programs_chunked", "operational_capability": "social protection program reach, adequacy, incidence, benefit distribution, and poverty/inequality reduction monitoring", "operational_mode": CAMPAIGN_MODE, "coverage_level": "implemented_compatible_wdi_social_protection_all_programs_chunked_annual_scalar_campaign", "region_id": (cat.get('region') or {}).get('id'), "region_label": (cat.get('region') or {}).get('value'), "income_level_id": (cat.get('incomeLevel') or {}).get('id'), "income_level_label": (cat.get('incomeLevel') or {}).get('value')})
...
def completion_semantics(manifest: dict[str, Any]) -> dict[str, Any]:
    indicator_results = manifest.get("classification", {}).get("indicator_results", {})
    acquisition_error_indicators = sorted(
        indicator
        for indicator, result in indicator_results.items()
        if result.get("provider_evidence_category") == "acquisition_error"
    )
    blocked = bool(acquisition_error_indicators)
    return {
        "status": "blocked_unresolved_acquisition_errors" if blocked else "complete",
        "unresolved_acquisition_error_count": len(acquisition_error_indicators),
        "unresolved_acquisition_error_indicators": acquisition_error_indicators,
        "can_claim_successful_completion": not blocked,
        "can_claim_candidate_set_exhaustion": not blocked,
        "can_claim_capability_closure": not blocked,
    }
...
def write_artifacts(raw_all: dict[str, Any]) -> dict[str, Any]:
    ...
    for idx, indicators in enumerate(_chunks(CANDIDATE_INDICATORS, CHUNK_SIZE), start=1):
        ...
        norm_path=NORM_CHUNK_DIR / f"task-206-wdi-social-protection-all-programs-normalized-chunk-{idx:02d}.json"
    ...
    manifest["completion_semantics"] = completion_semantics(manifest)
...
def main(argv: list[str] | None=None) -> int:
    ...
    if args.command=='fetch':
        ...
        print(json.dumps({"status": completion["status"], "candidate_count": manifest['candidate_count'], "chunk_count": manifest['chunk_count'], "included_indicator_count": manifest['included_indicator_count'], "excluded_indicator_count": manifest['excluded_indicator_count'], "row_count": manifest['row_count'], "elapsed_seconds": raw['scope'].get('elapsed_seconds'), "unresolved_acquisition_error_count": completion["unresolved_acquisition_error_count"]}, sort_keys=True))
        if completion["unresolved_acquisition_error_count"]:
            return 2
        ...
        manifest=write_artifacts(raw); completion = manifest["completion_semantics"]; print(json.dumps({"status": completion["status"], "row_count": manifest['row_count'], "unresolved_acquisition_error_count": completion["unresolved_acquisition_error_count"]}, sort_keys=True))
        if completion["unresolved_acquisition_error_count"]:
            return 2
    return 0
